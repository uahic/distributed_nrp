...
class RPCInPort(Port):
    ...
    def __init__(self, music_setup, port_name, accLatency, maxBuffered=-1):
        super(RPCPort, self).__init__()
        self._callbacks = {}
...
class ContOutputPort(Port):
    ...
    def __init__(self, music_setup, port_name, buffer_obj, maxBuffered=-1):
        super(ContOutputPort, self).__init__()
...
class ContInputPort(Port):
    ...
    def __init__(self, music_setup, port_name, buffer_obj, accLatency, maxBuffered=-1):
        super(ContInputPort, self).__init__()
        self._buffer = buffer_obj
        self._port = music_setup.publishContInput(port_name)
        self._port.map(self._buffer, delay=accLatency, maxBuffered=maxBuffered)

class MsgInputPort(Port):

    def __init__(self, music_setup, port_name, callback, accLatency, maxBuffered=-1, pickled=False):
        super(MsgInputPort, self).__init__()
...
class MsgOutputPort(Port):

    def __init__(self, music_setup, port_name, maxBuffered=-1, pickled=False):
        super(MsgOutputPort, self).__init__()
...
class EventInputPort(Port):
    ...
    def __init__(self, music_setup, port_name, callback, accLatency, music_index_type=music.Index.GLOBAL, maxBuffered=-1, perm=None, base=-1, size=-1):
        super(EventInputPort, self).__init__()
...
class EventOutputPort(Port):
    ...
    def __init__(self, music_setup, port_name, accLatency, music_index_type=music.Index.GLOBAL, maxBuffered=-1, perm=None, base=-1, size=-1):
        super(EventOutputPort, self).__init__()
